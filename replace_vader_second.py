...
# Same VADER sentiment data for the second sentimentByPIR block
new_pir_data = [
...
# Lines 950-1040 (0-indexed: 950-1040)
# Replace lines 950-1040 with new data (the closing }; is at line 1040)
new_lines = lines[:950] + new_pir_data + lines[1041:]

# Save
with open(md_path, 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("Replaced second sentimentByPIR data (lines 951-1041)")
