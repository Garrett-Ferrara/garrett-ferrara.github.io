...
* **Coding projects** accomplished through Claude Code, which included the scraper used in [Black Box Network Sense](/portfolio/black-box-network-sense/), the LLM analysis tool used in [Brand Reputation in the Post-Search Web](/portfolio/llm-inquiry-reputational-risk/), and this website itself.
